...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post data_url, params: { datum: { apply_count: @datum.apply_count, keyword: @datum.keyword, slot: @datum.slot, url: @datum.url } }
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { apply_count: @datum.apply_count, keyword: @datum.keyword, slot: @datum.slot, url: @datum.url } }
