...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post hotels_url, params: { hotel: { content: @hotel.content, name: @hotel.name, slot: @hotel.slot, url: @hotel.url } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { content: @hotel.content, name: @hotel.name, slot: @hotel.slot, url: @hotel.url } }
